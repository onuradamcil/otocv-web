    ...
    <div className="min-h-screen bg-[#FFFDFB] text-[#0F172A] font-sans antialiased flex flex-col justify-between select-none">
      ...
      <div className="max-w-5xl w-full mx-auto px-4 pt-8 flex justify-between items-center">
        <button 
          ...
          className="flex items-center gap-1 text-slate-500 hover:text-[#0F172A] transition-colors font-semibold text-xs"
        >
      ...
      <div className="w-full mx-auto px-4 py-6 flex-1 flex flex-col justify-center items-center">
        
        {/* MERKEZİ ORTALI LOGO ALANI */}
        <div className="mb-6 text-center select-none">
          <span className="text-2xl font-display font-black tracking-tight text-[#0F172A]">OTO.CV</span>
        </div>
            ...
            <form onSubmit={handleAuthSubmit} className="space-y-4 animate-fadeIn">
              ...
              <div className="space-y-1 relative">
                ...
                <div className="relative">
                  ...
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-[#0F172A] transition-colors">
                    {showPassword ? (
