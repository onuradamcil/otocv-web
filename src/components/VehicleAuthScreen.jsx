    ...
    <div className="flex-1 flex flex-col justify-center select-none">
      ...
      <div className="w-full mx-auto px-4 py-10 flex-1 flex flex-col justify-center items-center">
        ...
        <div className="w-full max-w-md bg-white border border-slate-200/70 rounded-[32px] shadow-[0_20px_50px_rgba(15,23,42,0.01)] p-8 md:p-9 flex flex-col space-y-5 relative overflow-hidden">
          ...
          {errorMessage && (
            <div className="bg-red-50 border border-red-100 text-red-600 text-yardimci font-semibold px-4 py-2.5 rounded-xl flex items-start gap-2 animate-fadeIn">
          ...
          {successMessage && (
            <div className="bg-emerald-50 border border-emerald-100 text-emerald-700 text-yardimci font-semibold px-4 py-2.5 rounded-xl flex items-start gap-2 animate-fadeIn">
          ...
          {authMode === 'login' && (
            <form onSubmit={handleAuthSubmit} className="space-y-4 animate-fadeIn">
              <div className="space-y-1">
                ...
                <input id="alan-e-posta-adresi" type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="ornek@otocv.com" className="w-full py-2.5 px-3.5 bg-[#FFFDFB] border border-slate-200 focus:border-[#0F172A] text-xs font-medium rounded-xl focus:outline-none transition-colors shadow-sm" />
              </div>
              ...
              <div className="space-y-1 relative">
                ...
                <div className="relative">
                  <input id="alan-sifre" type={showPassword ? 'text' : 'password'} required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="w-full py-2.5 px-3.5 bg-[#FFFDFB] border border-slate-200 focus:border-[#0F172A] text-xs font-medium rounded-xl focus:outline-none transition-colors pr-12 shadow-sm" />
            ...
            <form onSubmit={handleAuthSubmit} className="space-y-3.5 animate-fadeIn">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  ...
                  <input id="alan-adiniz" type="text" required value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="Örn: Ahmet" className="w-full py-2 px-3 border border-slate-200 rounded-xl text-xs font-medium focus:outline-none focus:border-[#0F172A] transition-colors" />
                </div>
                <div className="space-y-1">
                  ...
                  <input id="alan-soyadiniz" type="text" required value={lastName} onChange={(e) => setLastName(e.target.value)} placeholder="Örn: Yılmaz" className="w-full py-2 px-3 border border-slate-200 rounded-xl text-xs font-medium focus:outline-none focus:border-[#0F172A] transition-colors" />
                </div>
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1 relative">
                ...
                <div className="relative">
                  <input id="alan-sifre-belirle" type={showPassword ? 'text' : 'password'} required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="w-full py-2 px-3 border border-slate-200 rounded-xl text-xs font-medium focus:outline-none focus:border-[#0F172A] pr-12 transition-colors" />
                  {/* Etiket BUTONDA: içeriği tek başına ikon olan butonun adını ekran
                      okuyucu ancak buradan öğrenir. aria-pressed açık/kapalı
                      durumunu bildirir. 44px dokunma alanı WCAG asgarisi. */}
                  <button
