            ...
            <form onSubmit={handleAuthSubmit} className="space-y-3.5 animate-fadeIn">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  ...
                  <input id="alan-adiniz" type="text" required value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="Örn: Ahmet" className="w-full py-2 px-3 border border-slate-200 rounded-md text-xs font-medium focus:outline-none focus:border-[#0F172A] transition-colors" />
                </div>
                <div className="space-y-1">
                  ...
                  <input id="alan-soyadiniz" type="text" required value={lastName} onChange={(e) => setLastName(e.target.value)} placeholder="Örn: Yılmaz" className="w-full py-2 px-3 border border-slate-200 rounded-md text-xs font-medium focus:outline-none focus:border-[#0F172A] transition-colors" />
                </div>
              </div>
              <div className="space-y-1">
                ...
                <input id="alan-cep-telefonu-sifirsiz" 
                  ...
                  className="w-full py-2 px-3 border border-slate-200 rounded-md text-xs font-medium focus:outline-none focus:border-[#0F172A] transition-colors font-mono tracking-widest text-slate-800" 
                />
              </div>
              <div className="space-y-1 relative">
                ...
                <div className="relative">
                  <input id="alan-sifre-belirle" type={showPassword ? 'text' : 'password'} required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="w-full py-2 px-3 border border-slate-200 rounded-md text-xs font-medium focus:outline-none focus:border-[#0F172A] pr-12 transition-colors" />
                  {/* Etiket BUTONDA: içeriği tek başına ikon olan butonun adını ekran
                      okuyucu ancak buradan öğrenir. aria-pressed açık/kapalı
                      durumunu bildirir. 44px dokunma alanı WCAG asgarisi. */}
                  <button
              ...
              <button type="submit" disabled={loading} className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-2.5 rounded-md font-semibold text-xs tracking-wide shadow-md transition-colors active:scale-[0.98] mt-2">
