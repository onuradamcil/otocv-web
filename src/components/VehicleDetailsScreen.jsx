...
export default function VehicleDetailsScreen({ vehicle, kayitlar = null, onBack, onViewKarne, isPublicView = false, onManageInGarage }) {
  ...
  // =========================================================================
  // KAPORTA PARÇALARI — ⚠ BEYAN EDİLMEYEN PARÇA "ORİJİNAL" DEĞİLDİR
  // =========================================================================
  // Buradaki varsayılan `'ORIGINAL'` idi ve bu, bu projedeki EN AĞIR uydurma
  // veri hatasıydı:
  //
  //   Kaporta paneline hiç dokunmamış bir araçta `damage_report` boş ({})
  //   geliyor. Eski kodda 13 parçanın 13'ü de "Orijinal" sayılıyor, şemada
  //   YEŞİL boyanıyor ve alıcıya "Orijinal (13)" diye sayı veriliyordu.
  //
  ...
  // Bu, tramer alanında bilerek çözülen sorunun aynısı: orada da boş beyan
  // 'Hasarsız' yazılıyordu ve 'Bilmiyorum'a çevrildi.
  //
  // ⚠ ASİMETRİ KANITI: sihirbazın GİRİŞ ekranı (Step2ListingDetails) aynı
  // veri için `|| 'UNSPECIFIED'` kullanıyor. Yani aracın sahibi kendi
  // ekranında GRİ görüyor, alıcı aynı araçta YEŞİL görüyordu.
  //
  // İkinci kanıt kodun kendi içindeydi: aşağıdaki `UNSPECIFIED` kovasına
  // hiçbir zaman eleman giremiyordu, ama lejantta "Belirtilmemiş" noktası
  // duruyordu — ulaşılamayan bir durumu tarif eden ölü bir açıklama.
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-start">
              ...
              <div className="md:col-span-4 space-y-3">
                ...
                <div className={`rounded-md p-3.5 flex items-center justify-between border ${
                  ...
                  <div>
                    <span className="text-yardimci font-semibold uppercase text-slate-700 font-mono">
                      OTO.CV SİCİL PUANI
                    </span>
                  ...
                  <div className="space-y-1.5 text-mini divide-y divide-slate-200/70">
                    ...
                    {!isPublicView && (
                      <div className="flex justify-between items-center py-1">
                        ...
                        <span className="font-mono text-slate-800 font-semibold text-yardimci uppercase bg-slate-200/60 px-1.5 py-0.5 rounded">{ownerPlate}</span>
                      </div>
                    )}
              ...
              <div className={`px-4 py-3 border-b ${
                ...
                <div className="flex items-baseline justify-between gap-2">
                  ...
                  <span className="flex items-baseline gap-0.5">
                    ...
                    <span className="text-yardimci font-bold text-slate-500 font-mono">/100</span>
                  </span>
                </div>
              </div>
