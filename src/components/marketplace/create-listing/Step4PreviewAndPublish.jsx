...
export default function Step4PreviewAndPublish({ formData = {}, updateFormData, onBack, onEdit, onSuccess, user = {} }) {
  ...
  const getGroupedParts = () => {
    ...
    CAR_PARTS.forEach((part) => {
      const status = damageReport[part.id] || 'UNSPECIFIED';
      if (grouped[status]) grouped[status].push(part.name);
      else grouped.UNSPECIFIED.push(part.name);
    });
    return grouped;
  };
      ...
      <div className="bg-slate-900 text-white rounded-md p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-md border border-slate-800 relative z-20 overflow-hidden">
        ...
        <div className="flex items-center gap-3.5 z-10">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2 flex-wrap">
              <h4 className="text-mini sm:text-govde font-semibold tracking-tight text-white">
            ...
            <p className="text-mini text-slate-500 font-normal leading-relaxed">
        ...
        <div className="w-full sm:w-auto shrink-0 z-10 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-800">
          <button
            ...
            className="w-full sm:w-auto px-4 py-2.5 bg-indigo-600 hover:bg-indigo-500 active:scale-98 text-white rounded-lg text-mini font-semibold transition-all shadow-xs cursor-pointer flex items-center justify-center gap-2 border border-indigo-500/50"
          >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-slate-100 pb-3">
              <div className="space-y-1">
                ...
                {(formData.city || formData.district) ? (
                  ...
                  <p className="text-mini font-bold text-amber-700 flex items-center gap-1.5">
              ...
              <div className="flex items-center gap-2 shrink-0 self-end sm:self-auto">
                {onEdit && (
                  <button type="button" onClick={onEdit} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-md text-mini font-bold transition-all cursor-pointer flex items-center gap-1.5 border border-slate-200/80">
                    <Icon name="duzenle" size="sm" />
                    Bilgileri Düzenle
                  </button>
                )}
                <span className="text-mini font-mono font-bold bg-indigo-50 text-indigo-700 px-3 py-1.5 rounded-md border border-indigo-100">
              ...
              <div className={`w-full flex items-center justify-between px-4 sm:px-6 transition-all duration-300 overflow-hidden bg-slate-50/95 backdrop-blur-md ${isSticky ? 'h-[76px] sm:h-[80px] border-b border-slate-200/90 opacity-100' : 'h-0 opacity-0 border-transparent'}`}>
                <div className="flex items-center gap-4 min-w-0 py-2">
                  ...
                  <div className="flex flex-col min-w-0 justify-center gap-1.5">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="text-mini text-slate-600 font-semibold font-mono leading-none hidden sm:inline">
                ...
                <div className="hidden sm:flex items-center gap-2 shrink-0 py-2">
                  <div className="bg-white border border-slate-200/90 px-3.5 py-1.5 rounded-lg flex items-center gap-2 shadow-2xs">
                    ...
                    <span className="text-mini sm:text-govde font-semibold font-mono text-slate-500 leading-none">—/100</span>
                  </div>
                </div>
              </div>
              ...
              <div id="sec-description" className="space-y-3 pt-2 scroll-mt-32">
                ...
                {formData.description ? (
                  <div className="bg-slate-50/50 border border-slate-100 rounded-md p-4 h-[350px] overflow-y-auto custom-scrollbar">
                    <div 
                      className="prose prose-slate max-w-none text-mini sm:text-govde text-slate-700 leading-relaxed font-normal"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
                        ...
                        <g fill="none" fillRule="evenodd">
                          <g transform="translate(156.5 219.5) rotate(-90) translate(-188.5 -144.5)">
                            <g transform="translate(0)">
                              ...
                              <path d="m340 201.35c3.7652 1.6125 7.7313 2.4968 11.798 2.4968h15.864c3.2632 0 5.9742-2.8609 6.1248-6.5021 0.70284-16.958 1.1547-34.643 1.1547-53.005v-0.41614c0-18.518-0.40162-36.36-1.1547-53.422-0.15061-3.6412-2.8616-6.5021-6.1248-6.5021h-15.864c-4.0664 0-8.0325 0.83227-11.798 2.4968v114.85z" fill={DAMAGE_STATUSES[damageReport['front_bumper'] || 'UNSPECIFIED'].hex} fillRule="nonzero" stroke="#CBD5E1" strokeWidth="1.5" />
                              ...
                              <path d="m59.277 54.594s6.1176 1.9503 15.529 0.97517l5.3646 0.29255s9.2234 7.5088 12.047 7.2163c2.8235-0.34131 7.7175-8.4352 7.7175-8.4352l10.635-19.503c-0.14118 0.24379-15.2 3.4131-22.164-1.414-6.0234-4.1932-10.682-10.824-11.482-17.846l-0.79999-4.8759s-9.3175-0.39007-12.329 6.5824c-3.0117 6.9725-6.5411 9.4592-6.5411 9.4592s-0.94116 10.629 0.79999 13.262c1.6941 2.5842 1.2235 14.286 1.2235 14.286z" fill={DAMAGE_STATUSES[damageReport['fender_rear_left'] || 'UNSPECIFIED'].hex} fillRule="nonzero" stroke="#CBD5E1" strokeWidth="1.5" />
                              <path transform="translate(267.88 27.237) scale(-1) rotate(180) translate(-267.88 -27.237)" d="m234.26 49.983l53.188-9.0296s15.014-4.4657 16.577-8.6861c1.563-4.2204 2.3681-7.0176 1.563-10.109-0.80516-3.0917-2.8418-10.502-2.8418-10.502s3.3154-6.1833-0.61572-6.1833c-3.9311 0-15.958-0.98148-15.958-0.98148s2.3211 32.474-25.531 32.907c-25.568 0.39668-24.904-28.637-24.904-28.637h-5.8815s5.7309 23.212 0 41.222h4.4042z" fill={DAMAGE_STATUSES[damageReport['fender_front_left'] || 'UNSPECIFIED'].hex} fillRule="nonzero" stroke="#CBD5E1" strokeWidth="1.5" />
                              ...
                              <path d="m36.941 86.497c-3.7652-1.6125-7.7313-2.4968-11.798-2.4968h-15.864c-3.2632 0-5.9742 2.8609-6.1248 6.5021-0.70284 16.958-1.1547 34.643-1.1547 53.005v0.41614c0 18.518 0.40162 36.36 1.1547 53.422 0.15061 3.6412 2.8616 6.5021 6.1248 6.5021h15.864c4.0664 0 8.0325-0.83228 11.798-2.4968v-114.85z" fill={DAMAGE_STATUSES[damageReport['rear_bumper'] || 'UNSPECIFIED'].hex} fillRule="nonzero" stroke="#CBD5E1" strokeWidth="1.5" />
                            </g>
                          </g>
                        </g>
                      </svg>
                  ...
                  <div className="lg:col-span-6 space-y-4">
                    <div className="bg-slate-50/80 border border-slate-200/80 rounded-md p-4 space-y-3">
                      ...
                      {/* ⚠ BEYAN EDİLMEMİŞ PARÇALAR — BU BLOK YOKTU.
                          Beyan edilmemiş parça artık "Orijinal" sayılmıyor ama
                          listelenmediği için de görünmez kalıyordu. Alıcının
        ...
        <div className={`rounded-lg border p-4 sm:p-5 transition-colors ${
          ...
          >
            ...
            <span className="min-w-0">
              <span className="block font-semibold text-govde text-slate-900">
                Aracınız aramada görünsün
              </span>
              <span className="block text-mini text-slate-600 leading-relaxed mt-1">
          ...
          {formData.gorunurluk === 'gizli' && (
            <p className="mt-3 pt-3 border-t border-amber-200 text-mini text-amber-900 leading-relaxed">
     ...
     {/* 🚀 ALT AKSİYON BUTONLARI */}
      <div className="flex items-center justify-between pt-6 pb-12 relative z-20">
        ...
        <button 
          type="button"
          onClick={onSuccess}
          className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-mini sm:text-govde py-3.5 px-8 rounded-lg transition-all shadow-sm cursor-pointer select-none active:scale-98 flex items-center gap-2"
        >
