  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 animate-fadeIn space-y-8 select-none">
      ...
      <div className="flex justify-center">
        <div className="p-1 bg-slate-100/80 border border-gray-200/50 rounded-lg flex items-center gap-1 w-full max-w-[380px]">
          <button 
            type="button"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 bg-white border border-gray-200/80 rounded-lg p-6 md:p-8 shadow-sm min-h-[420px] flex flex-col justify-between">
          {verifyTab === 'pin' ? (
            ...
            <div className="space-y-5 animate-fadeIn flex-1 flex flex-col justify-between">
              ...
              <div className="w-full h-56 bg-slate-950 border border-slate-800 rounded-lg relative overflow-hidden flex flex-col items-center justify-center text-center shadow-inner group">
                {isQrScanning ? (
                  <>
                  ...
                  <>
                    <div className="w-28 h-28 border-2 border-dashed border-slate-700 rounded-lg flex items-center justify-center text-slate-600 relative select-none">
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="bg-[#0B1329] border border-slate-800 p-6 rounded-lg text-white space-y-4 shadow-xl relative overflow-hidden">
            ...
            <div className="flex gap-3 items-start relative z-10">
              <div className="w-10 h-10 rounded-md bg-white/5 border border-white/10 flex items-center justify-center text-indigo-400 shrink-0 shadow-inner">
