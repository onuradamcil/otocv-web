  ...
  return (
    <div className="relative inline-block text-left select-none" ref={dropdownRef}>
      ...
      <button
        ...
        className="relative p-2.5 text-slate-500 hover:text-[#0F172A] bg-slate-50 hover:bg-slate-100 rounded-full transition-all active:scale-95 focus:outline-none border border-slate-100"
      >
