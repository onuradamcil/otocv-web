  ...
  return (
    <div className="relative inline-block text-left select-none" ref={dropdownRef}>
      ...
      <button
        ...
        /* ⚠ RENKLER KOYU ŞERİDE GÖRE. Zil beyaz şerit için yazılmıştı
           (`bg-slate-50` + `text-slate-500`); şerit `#0F172A` olunca
           koyu zeminde PARLAK BİR DAİRE olarak duruyor ve gözü
           logodan da aramadan da çalıyordu. Artık şeffaf: ikon açık,
           üzerine gelince zeminden bir kademe açılıyor.
           Okunmamış rozeti (rose) kendi kontrastını taşıyor. */
        className="relative w-11 h-11 grid place-items-center text-slate-200 hover:text-white bg-transparent hover:bg-white/10 rounded-full transition-colors active:scale-95 odak-acik"
      >
